...
def roulette(guess, bet):
    ...
    #A standard roulette wheel has the numbers 0 through 36 as well as 00.
    #We'll use 37 to represent 00.
    print("------------------")
    ...
    #Checks to see if we guessed Even and the result was even. If the result was 0,
    #the player shouldn't win
    ...
    #Checks to see if we guessed Odd and the result was odd. If the result was 37,
    #the player shouldn't win, since that's what we are using to represent 00.
